...
**Adresa Repository:** [https://github.com/deeetzy/Fernweh-Monkey](https://github.com/deeetzy/Fernweh-Monkey)
...
## Pași de Compilare a Aplicației din Codul Sursă
În cazul în care se dorește compilarea manuală a proiectului direct din Unity:
1. Asigurați-vă că aveți instalat **Unity Editor** prin Unity Hub.
2. Clonați sau descărcați acest repository pe dispozitivul local.
3. Din Unity Hub, selectați **Add / Open** și deschideți folderul proiectului.
4. Navigați în meniul superior la **File > Build Settings**.
5. Verificați ca scenele jocului să fie adăugate în *Scenes in Build*.
6. Selectați platforma dorită (Windows, Mac, Linux) și apăsați **Build**, alegând folderul de destinație.
